              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      poppinsText(
                          text: Constants.convertTime(widget
                              .trip
                  ...
                  Row(
                    ...
                    children: [
                      poppinsText(
                          text: widget.trip.itineraries[itineraryIndex]
                  ...
                  Row(
                    children: [
                      SizedBox(
                          width: 120,
                          child: poppinsText(
                              text: Constants.iataList[widget
                                  .trip
                                  .itineraries[itineraryIndex]
                                  .segments[index]
                                  .departure
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                poppinsText(
                                    text: Constants.convertDate(widget
                                        .trip
                                        .itineraries[itineraryIndex]
                                        .segments[index]
                                        .departure
