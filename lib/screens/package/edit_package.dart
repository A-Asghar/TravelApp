...
class _EditPackageFormState extends State<EditPackageForm> {
  ...
  void initState() {
    ...
    _startDateController.text = Constants.convertDate(widget.package.startDate);
    _selectedDate = widget.package.startDate;
  ...
  Widget build(BuildContext context) {
    String to = widget.package.destination;
    return Scaffold(
      appBar: AppBar(
        title: poppinsText(
            text: 'Edit Package',
                          ...
                          onPressed: () async {
                            if (_formKey.currentState?.validate() ?? false) {
                              ...
                              context
                                  ...
                                  .agencyPackages[widget.index] = editedPackage;
                              ...
                              try {
                                ...
                                await pak.updatePackage(package: editedPackage);
                                setState(() {
                                  isLoading = false;
                                });
                                Navigator.pop(context);
