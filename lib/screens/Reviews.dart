    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: poppinsText(
              text: "Reviews", size: 24.0, fontBold: FontWeight.w500),
          centerTitle: true,
        ),
        body: Column(
          children: [
...
class Reviews2 extends StatefulWidget {
  const Reviews2({Key? key, required this.property}) : super(key: key);
  final PropertySearchListing property;
          ...
          children: [
            ...
            Expanded(
              child: ListView.builder(
                shrinkWrap: true,
                physics: const BouncingScrollPhysics(),
                itemCount: homeProvider.hotelReviews.length,
                itemBuilder: (context, index) {
                  var review = homeProvider.hotelReviews[index];
                  return Padding(
                    padding:
                        const EdgeInsets.only(bottom: 20, left: 20, right: 20),
                    child: Padding(
