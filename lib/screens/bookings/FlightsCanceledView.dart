...
class FlightsCanceledView extends StatefulWidget {
  const FlightsCanceledView({Key? key}) : super(key: key);

  @override
  State<FlightsCanceledView> createState() => _FlightsCanceledViewState();
}

class _FlightsCanceledViewState extends State<FlightsCanceledView> {
  @override
